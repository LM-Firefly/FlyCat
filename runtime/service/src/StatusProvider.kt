...
import com.github.lmfirefly.flycat.runtime.api.contract.LocalRuntimeStatusContract
import com.github.lmfirefly.flycat.runtime.api.contract.RegisteredContracts
import com.github.lmfirefly.flycat.runtime.api.contract.RuntimePhase
import com.github.lmfirefly.flycat.runtime.api.contract.RuntimeServiceContractRegistry
import com.github.lmfirefly.flycat.runtime.api.contract.RuntimeTargetMode
import com.github.lmfirefly.flycat.runtime.api.contract.toLocalRuntimePhase
import com.github.lmfirefly.flycat.runtime.api.contract.toRunMode
...
import com.github.lmfirefly.flycat.runtime.service.root.RootAccessSupport
import com.github.lmfirefly.flycat.runtime.service.root.RootPackageShell
import com.github.lmfirefly.flycat.runtime.service.root.RootTunBinding
import com.github.lmfirefly.flycat.runtime.service.root.RootTunBindingContractAdapter
import com.github.lmfirefly.flycat.runtime.service.root.RootTunRuntimeRecovery
import com.github.lmfirefly.flycat.runtime.service.root.RootTunStateStoreFactory
import com.github.lmfirefly.flycat.runtime.service.session.LocalRuntimeSessionHelpersImpl
...
class StatusProvider : ContentProvider() {
    ...
    companion object : LocalRuntimeStatusContract {
        ...
        const val ACTION_RUNTIME_PHASE_CHANGED = "com.github.lmfirefly.flycat.ACTION_RUNTIME_PHASE_CHANGED"
        ...
        fun isLocalRuntimeServiceAlive(mode: RunMode): Boolean {
            if (mode == RunMode.Tun) return false
            ...
            val targetClassName =
                when (mode) {
                    RunMode.VpnService -> TunService::class.java.name
                    RunMode.Tun -> return false
                    RunMode.Ebpf -> return false // eBPF runtime not yet tracked via service class
                }
