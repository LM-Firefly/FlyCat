...
package com.github.lmfirefly.flycat.runtime.service.config
...
class ServiceStore : ServiceStateReader {
    ...
    override var activeProfile: UUID? by
        store.typedString(
            key = "active_profile",
    ...
    val ebpfBypassCn: Boolean
        get() = readBoolean(newKey = "ebpfBypassCn", legacyKey = "ebpf_bypass_cn", defaultValue = false)
    ...
    var tunDnsMode: TunDnsMode
        get() = readEnum("rootTunDnsMode", TunDnsMode.RedirHost)
        set(value) {
