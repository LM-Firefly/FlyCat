...
class StatusProvider : ContentProvider() {
    ...
    companion object : LocalRuntimeStatusContract {
        ...
        const val ACTION_RUNTIME_PHASE_CHANGED = "com.github.yumelira.yumebox.ACTION_RUNTIME_PHASE_CHANGED"
        ...
        override fun reconcilePersistedRuntimeState() {
            ...
            if (persistedMode == RunMode.Tun || persistedPhase == RuntimePhase.Starting) {
                updateInMemoryRuntimeState(persistedMode, persistedPhase)
                return
            }
        ...
        private fun markRuntimePhase(mode: RunMode, phase: RuntimePhase) {
            if (mode == RunMode.Vpn && phase != RuntimePhase.Starting) {
                clearTunStarting()
            }
