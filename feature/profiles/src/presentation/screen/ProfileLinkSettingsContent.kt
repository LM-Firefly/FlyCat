...
import com.github.lmfirefly.flycat.core.model.profile.ProfileLink
import com.github.lmfirefly.flycat.locale.FlyTxt
import com.github.lmfirefly.flycat.presentation.component.card.SectionCard
...
private fun LinkOpenModeSection(mode: LinkOpenMode, onChange: (LinkOpenMode) -> Unit) {
    SectionCard(title = FlyTxt.ProfilesPage.LinkSettings.OpenMode) {
        PreferenceEnumItem(
            ...
            items =
                listOf(
                    FlyTxt.ProfilesPage.LinkSettings.OpenModeInApp,
                    FlyTxt.ProfilesPage.LinkSettings.OpenModeExternal,
                ),
...
private fun ProfileLinkList(
    ...
    SectionCard(title = FlyTxt.ProfilesPage.LinkSettings.Title) {
...
private fun LinkSettingsActions(onClose: () -> Unit, onAdd: () -> Unit) {
    ...
    Row(
        ...
        TextButton(
            text = FlyTxt.ProfilesPage.LinkSettings.Close,
            onClick = onClose,
