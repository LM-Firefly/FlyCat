...
internal fun ProfileSettingsDialog(
    ...
    AppActionBottomSheet(
        ...
        Column(modifier = Modifier.fillMaxWidth().wrapContentHeight().animateContentSize(animationSpec = tween(300, easing = FastOutSlowInEasing)).padding(bottom = UiDp.dp16), verticalArrangement = Arrangement.spacedBy(spacing.space16)) {
            Card {
            ...
            Crossfade(targetState = selectedSection, animationSpec = tween(200), label = "ProfileSettingsSection") { section ->
                when (section) {
                    ProfileSettingsSection.Subscription -> {
                            ...
                            Column(verticalArrangement = Arrangement.spacedBy(spacing.space4)) {
                                ...
                                Row(
                                    ...
                                    IconButton(
                                        ...
                                        Icon(imageVector = Yume.ArrowRight, contentDescription = FlyTxt.ProfilesPage.AgeKey.DerivePublicKey)
                                    }
                                    IconButton(
                                        onClick = {
                                            val clipboard = ageKeyContext.getSystemService(Context.CLIPBOARD_SERVICE) as ClipboardManager
                                        ...
                                        Icon(imageVector = Yume.Copy, contentDescription = FlyTxt.ProfilesPage.AgeKey.CopyPublicKey)
                                    }
                                }
                            }
                            ...
                            Column(verticalArrangement = Arrangement.spacedBy(spacing.space4)) {
                                ...
                                Row(
                                    ...
                                    IconButton(
                                        ...
                                        Icon(imageVector = Yume.Sparkles, contentDescription = FlyTxt.ProfilesPage.AgeKey.GenerateSecretKey)
                                    }
                                    IconButton(
                                        onClick = {
                                            val clipboard = ageKeyContext.getSystemService(Context.CLIPBOARD_SERVICE) as ClipboardManager
                                        ...
                                        Icon(imageVector = Yume.Copy, contentDescription = FlyTxt.ProfilesPage.AgeKey.CopySecretKey)
                                    }
                                    IconButton(
                                        onClick = { ageKeyVisible = !ageKeyVisible },
                                    ) {
                                        Icon(imageVector = Yume.Eye, contentDescription = if (ageKeyVisible) FlyTxt.ProfilesPage.AgeKey.HideKey else FlyTxt.ProfilesPage.AgeKey.ShowKey)
                                    }
                                }
                            }
                        }
                                ...
                                Card {
                                    LazyColumn(state = selectedOverrideListState, modifier = Modifier.fillMaxWidth().heightIn(max = componentSizes.profileSettingsListMaxHeight)) {
                                        items(overrideRowIds, key = { id -> "override-$id" }) { id ->
                                            ...
                                            Box(modifier = Modifier.fillMaxWidth().animateItem(fadeInSpec = tween(160), fadeOutSpec = tween(120), placementSpec = tween(220, easing = FastOutSlowInEasing))) {
                                                if (isSelected) {
