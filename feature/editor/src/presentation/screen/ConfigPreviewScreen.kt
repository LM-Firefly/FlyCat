            ...
            SmallTopBar(
                ...
                actions = if (!readOnly) {{
                    IconButton(
                        ...
                        Icon(Yume.ListCollapse, contentDescription = FlyTxt.Component.Editor.ConfigPreview.Format)
                    }
                    IconButton(
                        onClick = {
                        ...
                        Icon(Yume.Save, contentDescription = FlyTxt.Component.Editor.ConfigPreview.Save)
                    }
                }} else {{}},
            )
        }
