...
import com.github.lmfirefly.flycat.feature.dashboard.presentation.component.ConnectionCard
import com.github.lmfirefly.flycat.feature.dashboard.presentation.component.ConnectionDetailSheet
import com.github.lmfirefly.flycat.feature.dashboard.presentation.viewmodel.ConnectionSort
import com.github.lmfirefly.flycat.feature.dashboard.presentation.viewmodel.ConnectionTab
...
fun ConnectionScreen(navigator: Navigator) {
    ...
    var selectedConnection by remember {
        mutableStateOf<com.github.lmfirefly.flycat.core.model.ConnectionInfo?>(null)
    }
                ...
                actions = {
                    ...
                    IconButton(onClick = { showSearchBar = !showSearchBar }) {
                        Icon(
                            ...
                            contentDescription = FlyTxt.Connection.Search,
                            tint = MiuixTheme.colorScheme.onSurface,
                        )
                    }
                    IconButton(
        ...
        ScreenLazyColumn(
            ...
            item {
                AnimatedVisibility(
                    ...
                    enter =
                        expandVertically(
                            animationSpec = tween(AnimationSpecs.DURATION_CROSSFADE, easing = AnimationSpecs.StandardEasing),
                            expandFrom = Alignment.Top,
                        ) + fadeIn(animationSpec = tween(AnimationSpecs.DURATION_CROSSFADE, easing = AnimationSpecs.StandardEasing)),
                    exit =
                        shrinkVertically(
                            animationSpec = tween(AnimationSpecs.DURATION_CROSSFADE, easing = AnimationSpecs.StandardEasing),
                            shrinkTowards = Alignment.Top,
                        ) + fadeOut(animationSpec = tween(AnimationSpecs.DURATION_CROSSFADE, easing = AnimationSpecs.StandardEasing)),
                ) {
                    Row(
