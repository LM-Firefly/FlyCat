...
fun MoeHomePage(
    ...
    val quote = remember(moeHomeQuote, moeHomeQuoteAuthor) { MoeQuote(text = moeHomeQuote.ifBlank { MLang.AppSettings.Interface.HomeQuoteDefault }, author = moeHomeQuoteAuthor.ifBlank { MLang.AppSettings.Interface.HomeQuoteAuthorDefault }) }
