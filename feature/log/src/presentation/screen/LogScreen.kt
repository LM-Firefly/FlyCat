...
package com.github.lmfirefly.flycat.feature.log.presentation.screen
...
import com.github.lmfirefly.flycat.presentation.icon.flycat.Play
import com.github.lmfirefly.flycat.presentation.icon.flycat.Square
...
private fun LogFileItem(fileInfo: LogFileInfo, index: Int, onClick: () -> Unit) {
    ...
    val animatedSize by animateFloatAsState(targetValue = fileInfo.size.toFloat(), animationSpec = tween(AnimationSpecs.DURATION_NORMAL), label = "log_file_size_animation")
