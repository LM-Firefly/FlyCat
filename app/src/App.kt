...
import com.github.yumelira.yumebox.feature.settings.presentation.screen.MoeWallpaperImporter
...
class App : Application() {
    ...
    private fun recoverIncompleteOperations() {
        ...
        val subStoreDataDir = com.github.yumelira.yumebox.feature.substore.SubStorePaths.dataDir
    ...
    override fun onTerminate() {
        runCatching {
            ...
            koin?.getOrNull<NetworkInfoService>()?.close()
        }
