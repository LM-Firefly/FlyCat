...
@Serializable
data class SubscriptionInfo(@SerialName("Upload") val upload: Long = 0, @SerialName("Download") val download: Long = 0, @SerialName("Total") val total: Long = 0, @SerialName("Expire") val expire: Long = 0) : Parcelable {
