...
/**
 * Utility wrappers for age key cryptographic operations backed by the native
 * mihomo/JNI surface.  All functions dispatch to [Dispatchers.Default] so
 * callers never execute JNI crypto on the UI thread.
 */
object AgeKeyCrypto {
