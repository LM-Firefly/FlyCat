...
package com.github.lmfirefly.flycat.core

import com.github.lmfirefly.flycat.core.bridge.Bridge
import com.github.lmfirefly.flycat.core.bridge.ClashException
import com.github.lmfirefly.flycat.core.bridge.FetchCallback
import com.github.lmfirefly.flycat.core.bridge.LogcatInterface
import com.github.lmfirefly.flycat.core.bridge.TunInterface
import com.github.lmfirefly.flycat.core.model.AgeKeyPair
import com.github.lmfirefly.flycat.core.model.CompileRawSummary
import com.github.lmfirefly.flycat.core.model.CompileRequest
import com.github.lmfirefly.flycat.core.model.CompileResult
...
import com.github.lmfirefly.flycat.core.model.NativeInspectResult
...
interface ClashEngine {
    ...
    fun queryGroupsBatch(names: List<String>, sort: ProxySort): List<ProxyGroup>
    // Health checks
...
object Clash : ClashEngine {
    ...
    override fun queryGroupsBatch(names: List<String>, sort: ProxySort): List<ProxyGroup> {
        if (names.isEmpty()) return emptyList()
        val namesJson = ClashJson.encodeToString(names)
        val response = Bridge.nativeQueryGroupsBatch(namesJson, sort.name) ?: return emptyList()
        return runCatching {
            ClashJson.decodeFromString(ListSerializer(ProxyGroup.serializer()), response)
        }.getOrElse { emptyList() }
    }
    ...
    override fun unsubscribeLogcat() {
