...
icon: rocket
---
<Info>FlyCat does not provide nodes or subscriptions, please prepare the configuration file or subscription address first. </Info>

## First time use

<Steps>
  <Step title="Install APK">
    Download and install the APK from [GitHub Releases](https://github.com/LM-Firefly/FlyCat/releases).
  ...
  <Step title="Service configuration">
    ...
    | `eBPF` | Root, eBPF | mihomo native eBPF listener |
