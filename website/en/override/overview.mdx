...
<Steps>
  <Step title="From the subscription card app">
    Open the subscription card, click **Edit**, select **Edit Settings**, then switch the **Setting Type** tab to **Override Configuration**.
...
When multiple overrides are applied to the same subscription, FlyCat executes them in list order; later overrides can modify previous results.
