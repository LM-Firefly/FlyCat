...
icon: terminal
---
JavaScript overrides run within FlyCat's built-in JavaScript environment. The following APIs are complete global methods provided by the runtime.
...
| `Buffer.isBuffer(value)` | Determine whether it is a FlyCat buffer object. |
