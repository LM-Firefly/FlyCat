...
<Frame><img src="/images/brand/project-preview.webp" alt="FlyCat 项目预览" noZoom={true} /></Frame>
...
## 下载
第一次使用 FlyCat，请先阅读[快速开始](/guide/quickstart)。
...
<CardGroup cols={2}>
  ...
  <Card title="工作流程" icon="route" href="/guide/workflow">
    了解配置到运行的流程。
  </Card>
