...
object CrashHandler : Thread.UncaughtExceptionHandler {
        ...
        try {
            ...
            file.printWriter().use { writer ->
                ...
                try {
                    ...
                    if (recentLogs.isNotEmpty()) { writer.println("\n--- Recent App Logs ---"); recentLogs.forEach { writer.println(it) }; writer.println("--- End Recent App Logs ---") }
    ...
    private fun saveRecentExitInfoToFile() {
        ...
        val exitInfos = activityManager.getHistoricalProcessExitReasons(ctx.packageName, 0, 10).filter { it.reason == ApplicationExitReason.NATIVE_CRASH || it.reason == ApplicationExitReason.ANR || it.reason == ApplicationExitReason.CRASH }
    ...
    // android.app.ApplicationExitReason (API 30+)
