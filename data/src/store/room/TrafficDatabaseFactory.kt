...
private val MIGRATION_1_2 = object : Migration(1, 2) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("DROP TABLE `app_traffic_daily`")
        db.execSQL("ALTER TABLE `app_traffic_daily_new` RENAME TO `app_traffic_daily`")
        // --- route_traffic_daily ---
        db.execSQL(
            """
        ...
        db.execSQL("DROP TABLE `route_traffic_daily`")
        db.execSQL("ALTER TABLE `route_traffic_daily_new` RENAME TO `route_traffic_daily`")
    }
}
