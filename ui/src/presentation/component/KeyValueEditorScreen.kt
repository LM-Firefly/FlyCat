    ...
    EditorScaffold(
        ...
        actions = remember(isOverrideRuleEditor) {
            listOf(
                ...
                EditorAction(icon = Yume.BadgePlus, contentDescription = FlyTxt.Component.Action.Add, onClick = { dialogState = if (isOverrideRuleEditor) { StringListDialogState.AddRule } else { StringListDialogState.Add } }),
            )
        },
    ) { innerPadding ->
