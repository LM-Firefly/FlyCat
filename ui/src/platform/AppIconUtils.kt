...
package com.github.lmfirefly.flycat.ui.platform
...
object AppIconUtils {
    private const val MAIN_ACTIVITY_ALIAS = "com.github.lmfirefly.flycat.MainActivityAlias"
    ...
    private fun setIconState(context: Context, hide: Boolean) {
        ...
        runCatching {
                ...
                val main =
                    ComponentName(context.packageName, "com.github.lmfirefly.flycat.MainActivity")
